...
<div class="container">
	<div class="row">
		...
		<form action="view.php?id=<?php echo $_GET['id']; ?>" method="POST" enctype="multipart/form-data">
			...
			<div class="form-group">
				<button type="submit" name="btnSubmit" class="btn btn-outline-success">Envoyer e-mail</button>
			</div>
		</div>
	</form>
		...
		<div class="col-md-6 float-right">
			<div class="card">
				...
				<div class="card-body">
					<p><strong>Nom</strong>: <?php echo $result['name']; ?></p>
					<p><strong>Email</strong>: <?php echo $result['email']; ?></p>
					<p><strong>Numéro de télephone</strong>: <?php echo $result['phone']; ?></p>
					<p><strong>Addresse</strong>: <?php echo $result['address']; ?></p>
					<p><strong>Déscription</strong>: <?php echo $result['description']; ?></p>
				</div>
			</div>
		</div>
<?php
